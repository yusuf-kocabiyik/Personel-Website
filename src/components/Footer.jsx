    ...
    return(
        <div className="w-full  lg:w-360 flex flex-col  gap-5 mx-auto lg:px-15 bg-[#F9F9F9] dark:bg-[#141414]">
            ...
            <div className="font-medium text-lg flex flex-col gap-3 lg:gap-0 lg:flex-row justify-between px-2">
                <a href="mailto:kocabiyikyusuf3@email.com?subject=Let's work together&body=Hi Yusuf," className="text-center mx-auto lg:mx-0 text-[#AF0C48] border-b-2 border-[#AF0C48] dark:text-[#BAB2E7] dark:border-[#BAB2E7]">{content.footer.email}</a>
                <div className="flex mx-auto lg:mx-0 justify-around lg:justify-between w-70">
                    ...
                    <a href="https://github.com/yusuf-kocabiyik" className="text-[#00AB6B]">{content.footer.links[1]}</a>
                    <a href="https://www.linkedin.com/in/yusufkocabiyik/" className="text-[#0077B5]">{content.footer.links[2]}</a>
                </div>
            </div>
            <br /><br />
